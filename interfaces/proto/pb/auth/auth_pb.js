...
goog.exportSymbol('proto.pb.BlockCommunityRequest', null, global);
goog.exportSymbol('proto.pb.BlockCommunityResponse', null, global);
...
goog.exportSymbol('proto.pb.Members', null, global);
goog.exportSymbol('proto.pb.Moderator', null, global);
 ...
 * @constructor
 */
proto.pb.Moderator = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.Moderator, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.Moderator.displayName = 'proto.pb.Moderator';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.Members = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.Members, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.Members.displayName = 'proto.pb.Members';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.BlockCommunityRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.BlockCommunityRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.BlockCommunityRequest.displayName = 'proto.pb.BlockCommunityRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.BlockCommunityResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.BlockCommunityResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.BlockCommunityResponse.displayName = 'proto.pb.BlockCommunityResponse';
}
 ...
 * @return {!Object}
 */
proto.pb.Moderator.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.Moderator.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.Moderator} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Moderator.toObject = function(includeInstance, msg) {
  var f, obj = {
    moderatorid: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.Moderator}
 */
proto.pb.Moderator.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.Moderator;
  return proto.pb.Moderator.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.Moderator} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.Moderator}
 */
proto.pb.Moderator.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.Moderator.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.Moderator.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.Moderator} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Moderator.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getModeratorid();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string moderatorId = 1;
 * @return {string}
 */
proto.pb.Moderator.prototype.getModeratorid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pb.Moderator} returns this
 */
proto.pb.Moderator.prototype.setModeratorid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.pb.Members.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.Members.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.Members} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Members.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.Members}
 */
proto.pb.Members.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.Members;
  return proto.pb.Members.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.Members} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.Members}
 */
proto.pb.Members.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.Members.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.Members.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.Members} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Members.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.pb.Members.prototype.getMemberid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pb.Members} returns this
 */
proto.pb.Members.prototype.setMemberid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.pb.CreateCommunityRequest.repeatedFields_ = [3,4];
...
proto.pb.CreateCommunityRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    moderatorsList: jspb.Message.toObjectList(msg.getModeratorsList(),
    proto.pb.Moderator.toObject, includeInstance),
    membersList: jspb.Message.toObjectList(msg.getMembersList(),
    proto.pb.Members.toObject, includeInstance),
    description: jspb.Message.getFieldWithDefault(msg, 5, ""),
    joinedtype: jspb.Message.getFieldWithDefault(msg, 6, "")
  };
...
proto.pb.CreateCommunityRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.pb.Moderator;
      reader.readMessage(value,proto.pb.Moderator.deserializeBinaryFromReader);
      msg.addModerators(value);
      break;
    case 4:
      var value = new proto.pb.Members;
      reader.readMessage(value,proto.pb.Members.deserializeBinaryFromReader);
...
proto.pb.CreateCommunityRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.pb.Moderator.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.pb.Members.serializeBinaryToWriter
    );
  }
...
/**
 * repeated Moderator moderators = 3;
 * @return {!Array<!proto.pb.Moderator>}
 */
proto.pb.CreateCommunityRequest.prototype.getModeratorsList = function() {
  return /** @type{!Array<!proto.pb.Moderator>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pb.Moderator, 3));
};


/**
 * @param {!Array<!proto.pb.Moderator>} value
 * @return {!proto.pb.CreateCommunityRequest} returns this
*/
proto.pb.CreateCommunityRequest.prototype.setModeratorsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.pb.Moderator=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pb.Moderator}
 */
proto.pb.CreateCommunityRequest.prototype.addModerators = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.pb.Moderator, opt_index);
};
 ...
 * @return {!proto.pb.CreateCommunityRequest} returns this
 */
proto.pb.CreateCommunityRequest.prototype.clearModeratorsList = function() {
  return this.setModeratorsList([]);
};


/**
 * repeated Members members = 4;
 * @return {!Array<!proto.pb.Members>}
 */
proto.pb.CreateCommunityRequest.prototype.getMembersList = function() {
  return /** @type{!Array<!proto.pb.Members>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pb.Members, 4));
};


/**
 * @param {!Array<!proto.pb.Members>} value
 * @return {!proto.pb.CreateCommunityRequest} returns this
*/
...
/**
 * @param {!proto.pb.Members=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pb.Members}
 */
proto.pb.CreateCommunityRequest.prototype.addMembers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.pb.Members, opt_index);
};
 ...
 * @return {!Object}
 */
proto.pb.BlockCommunityRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.BlockCommunityRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.BlockCommunityRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.BlockCommunityRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    communityid: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.BlockCommunityRequest}
 */
proto.pb.BlockCommunityRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.BlockCommunityRequest;
  return proto.pb.BlockCommunityRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.BlockCommunityRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.BlockCommunityRequest}
 */
proto.pb.BlockCommunityRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.BlockCommunityRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.BlockCommunityRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.BlockCommunityRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.BlockCommunityRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCommunityid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.pb.BlockCommunityRequest.prototype.getCommunityid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pb.BlockCommunityRequest} returns this
 */
proto.pb.BlockCommunityRequest.prototype.setCommunityid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.pb.BlockCommunityResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.BlockCommunityResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.BlockCommunityResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.BlockCommunityResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    status: jspb.Message.getFieldWithDefault(msg, 1, 0),
    message: jspb.Message.getFieldWithDefault(msg, 2, ""),
    error: jspb.Message.getFieldWithDefault(msg, 3, "")
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.BlockCommunityResponse}
 */
proto.pb.BlockCommunityResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.BlockCommunityResponse;
  return proto.pb.BlockCommunityResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.BlockCommunityResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.BlockCommunityResponse}
 */
proto.pb.BlockCommunityResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.BlockCommunityResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.BlockCommunityResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.BlockCommunityResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.BlockCommunityResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.pb.BlockCommunityResponse.prototype.getStatus = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.pb.BlockCommunityResponse} returns this
 */
proto.pb.BlockCommunityResponse.prototype.setStatus = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pb.BlockCommunityResponse.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pb.BlockCommunityResponse} returns this
 */
proto.pb.BlockCommunityResponse.prototype.setMessage = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.pb.BlockCommunityResponse.prototype.getError = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.pb.BlockCommunityResponse} returns this
 */
proto.pb.BlockCommunityResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
